 ...
 * @author TT124
 */
public class PostScreen1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostScreen1.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PostScreen1().setVisible(true);
            }
        });
    }
    ...
    public static void setEnvironment(String environment) {
        PostScreen1.environment = environment;
    }
    ...
    public static void setThreadGroupVal(int threadGroupVal) {
        PostScreen1.threadGroupVal = threadGroupVal;
    }
    ...
    public static void setDurationTime(int durationTime) {
        PostScreen1.durationTime = durationTime;
    }
    ...
    public static void setRampUpTime(int rampUpTime) {
        PostScreen1.rampUpTime = rampUpTime;
    }
    ...
    public static void setDelayTime(int delayTime) {
        PostScreen1.delayTime = delayTime;
    }
